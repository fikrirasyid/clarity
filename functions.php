...
function clarity_setup() {
	 ...
	 * If you're building a theme based on Clarity, use a find and replace
	 * to change 'clarity' to the name of your theme in all the template files
	 */
	...
	register_nav_menus( array(
		'primary' => __( 'Primary Menu', 'clarity' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'clarity_custom_background_args', array(
...
function clarity_scripts() {
	...
	wp_enqueue_script( 'clarity-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
